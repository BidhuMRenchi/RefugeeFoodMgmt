...
$a=$_POST['a'];
$b=$_POST['b'];
$query = "SELECT  * FROM   refugee, nationality WHERE refugee.nationality_nid= nationality.nid AND refugee.dateEntry BETWEEN '$a' AND '$b'";
...
// make the table
$pdf->ezTable($data,array('refNo'=>'Refugee No','Fname'=>'First Name','Lname'=>'Last Name','age'=>'Age','sex' =>'Gender','contact'=>'Phone','nationName'=>'HomeCountry'),"Refugee Report ");
